...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_variable_decl] = STATE(169),
    [sym_function_decl] = STATE(169),
    [sym_dimension_decl] = STATE(169),
    [sym_decorator] = STATE(169),
    [sym_unit_decl] = STATE(169),
    [sym_module_import] = STATE(169),
    [sym_procedure_call] = STATE(169),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(191)] = 6988,
  [SMALL_STATE(192)] = 6995,
  [SMALL_STATE(193)] = 7002,
  [SMALL_STATE(194)] = 7009,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [39] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition, 6, .production_id = 12),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 6, .production_id = 12),
  ...
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_power, 4, .production_id = 8),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_power, 4, .production_id = 8),
  ...
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_decl, 7, .production_id = 13),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_decl, 6, .production_id = 11),
  ...
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_decl, 8, .production_id = 14),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_decl, 5, .production_id = 9),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_decl, 6, .production_id = 10),
  ...
  [159] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(48),
  [162] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(30),
  [165] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(170),
  [168] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(180),
  [171] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(66),
  [174] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(176),
  [177] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(131),
  [180] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(123),
  [183] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(172),
  [186] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(171),
  [189] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(72),
  [192] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(74),
  [195] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(119),
  [198] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(37),
  [201] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(27),
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 3),
  ...
  [220] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__parenthesized_expression, 3),
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parenthesized_expression, 3),
  ...
  [232] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_annotation, 1),
  ...
  [288] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__dim_power, 3),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__dim_power, 3),
  [292] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__dim_primary, 3),
  [294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__dim_primary, 3),
  [296] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dimension_expr, 1),
  [298] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dimension_expr, 1),
  [300] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__dim_exponent, 3),
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__dim_exponent, 3),
  ...
  [338] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_minus, 1),
  [340] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_minus, 1),
  [342] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_multiply, 1),
  [344] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_multiply, 1),
  [346] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pow_symbol, 1),
  [348] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pow_symbol, 1),
  ...
  [370] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2),
  [372] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(116),
  ...
  [385] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module_import, 3),
  [387] = {.entry = {.count = 1, .reusable = true}}, SHIFT(164),
  [389] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module_import, 2),
  [391] = {.entry = {.count = 1, .reusable = true}}, SHIFT(151),
  [393] = {.entry = {.count = 1, .reusable = true}}, SHIFT(188),
  [395] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unit_decl, 1),
  [397] = {.entry = {.count = 1, .reusable = true}}, SHIFT(95),
  [399] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [401] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_module_import_repeat1, 2),
  [403] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_import_repeat1, 2), SHIFT_REPEAT(164),
  [406] = {.entry = {.count = 1, .reusable = true}}, SHIFT(111),
  [408] = {.entry = {.count = 1, .reusable = true}}, SHIFT(190),
  [410] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__list_of_aliases, 1),
  [412] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dimension_decl, 3, .production_id = 1),
  [414] = {.entry = {.count = 1, .reusable = true}}, SHIFT(92),
  [416] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dimension_decl, 2, .production_id = 1),
  [418] = {.entry = {.count = 1, .reusable = true}}, SHIFT(125),
  [420] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dimension_decl_repeat1, 2), SHIFT_REPEAT(92),
  [423] = {.entry = {.count = 1, .reusable = true}}, SHIFT(187),
  [425] = {.entry = {.count = 1, .reusable = true}}, SHIFT(129),
  [427] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__fn_decl_generic_repeat1, 2), SHIFT_REPEAT(174),
  [430] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__fn_decl_generic_repeat1, 2),
  ...
  [446] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__fn_decl_param_repeat1, 2), SHIFT_REPEAT(160),
  [449] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__fn_decl_param_repeat1, 2),
  ...
  [457] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__list_of_aliases, 2),
  [459] = {.entry = {.count = 1, .reusable = true}}, SHIFT(136),
  [461] = {.entry = {.count = 1, .reusable = true}}, SHIFT(141),
  [463] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fn_decl_param, 5),
  [465] = {.entry = {.count = 1, .reusable = true}}, SHIFT(193),
  [467] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__list_of_aliases, 3),
  [469] = {.entry = {.count = 1, .reusable = true}}, SHIFT(110),
  [471] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fn_decl_param, 2),
  [473] = {.entry = {.count = 1, .reusable = true}}, SHIFT(67),
  [475] = {.entry = {.count = 1, .reusable = true}}, SHIFT(86),
  [477] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fn_decl_param, 3),
  [479] = {.entry = {.count = 1, .reusable = true}}, SHIFT(154),
  [481] = {.entry = {.count = 1, .reusable = true}}, SHIFT(177),
  [483] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__list_of_aliases_repeat1, 2), SHIFT_REPEAT(146),
  [486] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fn_decl_param, 6),
  [488] = {.entry = {.count = 1, .reusable = true}}, SHIFT(87),
  [490] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [492] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fn_decl_param, 4),
  [494] = {.entry = {.count = 1, .reusable = true}}, SHIFT(90),
  [496] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__fn_decl_param_repeat1, 4),
  [498] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [500] = {.entry = {.count = 1, .reusable = true}}, SHIFT(88),
  [502] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__list_of_aliases, 4),
  ...
  [512] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_procedure_call, 4),
  ...
  [526] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fn_decl_generic, 4),
  ...
  [538] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decorator, 2),
  [540] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fn_decl_generic, 3),
  [542] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decorator, 4),
  [544] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__list_of_aliases_repeat1, 2),
  [546] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fn_decl_generic, 2),
  [548] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [550] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__list_of_aliases_repeat1, 4),
